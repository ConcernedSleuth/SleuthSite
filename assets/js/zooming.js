  ...
  var target = {
    ...
    calculateTranslate: function calculateTranslate() {
      ...
      var targetCenter = {
        ...
        y: this.rect.top + this.rect.height / 2 + 10,
    ...
    createClass(Zooming, [
      ...
      },
      {
        ...
        value: function open(el) {
          ...
          var cb =
            arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.options.onOpen;
      ...
      },
      {
        ...
        value: function grab(x, y) {
          ...
          var cb =
            arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : this.options.onGrab;
        ...
        value: function move(x, y) {
          var scaleExtra =
            arguments.length > 2 && arguments[2] !== undefined
              ...
              : this.options.scaleExtra;
          var cb =
            arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : this.options.onMove;
